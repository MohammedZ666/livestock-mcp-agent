...
const App: React.FC = () => {
  ...
  useEffect(() => {
    setChatHistory([
      { author: Author.BOT, content: "আমি সবারখামার বন্ধু। 🐄🐐🐓🌾 আমি আপনাকে শুধুমাত্র গবাদি পশু পালন এবং খামারের প্রাণী সংক্রান্ত বিষয়ে সাহায্য করতে পারি। আপনার যদি এই বিষয়ে কোনো প্রশ্ন থাকে, তাহলে জিজ্ঞাসা করতে পারেন।" }
    ]);
  }, []);
